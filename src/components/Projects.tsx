...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        "Autonomous order processing & insights system integrating Salesforce APIs with real-time AI insights",
      achievements: [
        "Improved tracking consistency by ~25% with Order Lifecycle AI Agent",
        "Achieved zero-downtime releases using Jenkins and Gearset for CI/CD",
        "Reduced deployment cycle time by ~30%",
        "Orchestrated data-rich agent workflows for real-time alerts and AI-driven insights",
      ],
      tech: [
        "LangChain agents",
        "REST API",
